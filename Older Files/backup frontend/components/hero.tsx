...
export function Hero() {
  ...
  return (
    <section id="home" className="relative flex flex-col">
      ...
      <VideoBackground className="z-0 min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)]">
        <div className="container mx-auto flex h-full flex-col items-center justify-center px-4 py-20 text-center text-white md:py-28">
          <h1 className="neon-text neon-interactive text-4xl font-semibold md:text-6xl">Predict Traffic. Plan Smarter Trips.</h1>
          <p className="neon-text neon-interactive mt-4 mx-auto max-w-2xl text-base opacity-90 md:text-lg">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            ...
            <a href="#features" className="rounded-full border border-white/40 px-5 py-2">
              Learn more
            </a>
          </div>
        </div>
